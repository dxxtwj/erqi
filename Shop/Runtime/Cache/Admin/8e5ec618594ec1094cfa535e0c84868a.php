...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="/TP-shop/Public/Admin/assets/css/font-awesome.min.css" />
		<!--[if IE 7]>
		  <link rel="stylesheet" href="/TP-shop/Public/Admin/assets/css/font-awesome-ie7.min.css" />
		<![endif]-->
		<link rel="stylesheet" href="/TP-shop/Public/Admin/assets/css/ace.min.css" />
		<link rel="stylesheet" href="/TP-shop/Public/Admin/assets/css/ace-rtl.min.css" />
		<link rel="stylesheet" href="/TP-shop/Public/Admin/assets/css/ace-skins.min.css" />
        <link rel="stylesheet" href="css/style.css"/>
		<!--[if lte IE 8]>
		  <link rel="stylesheet" href="/TP-shop/Public/Admin/assets/css/ace-ie.min.css" />
		<![endif]-->
		<script src="/TP-shop/Public/Admin/assets/js/ace-extra.min.js"></script>
		<!--[if lt IE 9]>
		<script src="/TP-shop/Public/Admin/assets/js/html5shiv.js"></script>
		<script src="/TP-shop/Public/Admin/assets/js/respond.min.js"></script>
		<![endif]-->
        <!--[if !IE]> -->
		...
		<!--[if lte IE 8]>
		  <script src="/TP-shop/Public/Admin/assets/js/excanvas.min.js"></script>
		<![endif]-->
		<script src="/TP-shop/Public/Admin/assets/js/ace-elements.min.js"></script>
		<script src="/TP-shop/Public/Admin/assets/js/ace.min.js"></script>
        ...
        <script src="/TP-shop/Public/Admin/js/jquery.nicescroll.js" type="text/javascript"></script>
...
<script type="text/javascript">
					...
					<ul class="nav nav-list" id="nav_list">
				     <li class="home"><a href="<?php echo U('Index/index');?>"  class="iframeurl" title=""><i class="icon-home"></i><span class="menu-text"> 系统首页 </span></a></li>
                     <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 产品管理 </span><b class="arrow icon-angle-down"></b></a>
					   <ul class="submenu">
                         <li class="home"><a  href="<?php echo U('Products/pp');?>"   title="产品类表" class="iframeurl"><i class="icon-double-angle-right"></i>产品类表</a></li>
