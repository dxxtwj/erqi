					...
					<div class="wrap-left">
						<div class="wrap-list">
							<div class="m-user">
								...
								<div class="m-userinfo">
									...
									<div class="m-baseinfo">
										...
										<div class="m-info">
											<em class="s-name"><?=session('user')['username']?></em>
								...
								<div class="wallet">
									...
									<p class="m-big squareS">
										<a href="#">
											<i><img src="/Public/Home/images/shopping.png"/></i>
											<span class="m-title">能购物</span>
										</a>
									</p>
									<p class="m-big squareA">
										<a href="#">
											<i><img src="/Public/Home/images/safe.png"/></i>
											<span class="m-title">够安全</span>
										</a>
									</p>
									<p class="m-big squareL">
										<a href="#">
											<i><img src="/Public/Home/images/profit.png"/></i>
							...
							<div class="m-order">
								...
								<ul>
									<li><a href="order.html"><i><img src="/Public/Home/images/pay.png"/></i><span>待付款</span></a></li>
									<li><a href="order.html"><i><img src="/Public/Home/images/send.png"/></i><span>待发货<em class="m-num">1</em></span></a></li>
									<li><a href="order.html"><i><img src="/Public/Home/images/receive.png"/></i><span>待收货</span></a></li>
									<li><a href="order.html"><i><img src="/Public/Home/images/comment.png"/></i><span>待评价<em class="m-num">3</em></span></a></li>
									<li><a href="change.html"><i><img src="/Public/Home/images/refund.png"/></i><span>退换货</span></a></li>
								</ul>
									<?php if(is_array($orders)): foreach($orders as $key=>$v): ?><div class="orderContentBox">
											<div class="orderContent">
												<div class="orderContentpic">
													<div class="imgBox">
														<a href="orderinfo.html"><img src="/Public/Home/images/youzi.jpg"></a>
													</div>
												</div>
												<div class="detailContent">
													<a href="orderinfo.html" class="delivery">签收</a>
													<div class="orderID">
														<span class="time"><?php echo ($v['atime']); ?></span>
													</div>
													<div class="orderID">
														<span class="num">共<?php echo ($v["number"]); ?>件商品</span>
													</div>
												</div>
												<div class="state"><?php echo ($v["state"]); ?></div>
												<div class="price"><span class="sym">¥</span><?php echo ($v["productmoney"]); ?></div>
							...
							<div class="user-squaredIcon">
								...
								<ul>
									...
									<a href="/Public/Home/home/home2.html">
								...
								<div class="twoTabModel credit">
									...
									<div class="Box">
										...
										<div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:108, itemMargin:3, slideshow: false}">
											<ul class="am-slides">
												<li><a href="#"><img src="/Public/Home/images/333.jpg" /></a></li>
												<li><a href="#"><img src="/Public/Home/images/222.jpg" /></a></li>
												<li><a href="#"><img src="/Public/Home/images/111.jpg" /></a></li>
												<li><a href="#"><img src="/Public/Home/images/333.jpg" /></a></li>
												<li><a href="#"><img src="/Public/Home/images/222.jpg" /></a></li>
												<li><a href="#"><img src="/Public/Home/images/111.jpg" /></a></li>
											</ul>
							...
							<div class="new-goods-info">
								<a class="shop-info" href="#">
									<div class="face-img-panel">
										<img src="/Public/Home/images/imgsearch1.jpg" alt="">
									</div>
						...
						<div class="new-goods">
							...
							<div class="new-goods-info">
								<a class="shop-info" href="#" target="_blank">
									<div >
										<img src="/Public/Home/images/666.jpg" alt="">
									</div>
                        ...
                        <div class="am-tabs-bd">
                            ...
                            <div data-tab-panel-0 class="am-tab-panel am-active">
                        		<div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:155,slideshow: false}">
									<ul class="am-slides">
                                       <li>
                                       	  <a><img class="am-thumbnail" src="/Public/Home/images/EZA27501.jpg" /></a>
                                       	  <strong class="price">¥32.9</strong>
                                       </li>
                                       <li>
                                       	  <a><img class="am-thumbnail" src="/Public/Home/images/BxJk6.jpg" /></a>
                                       	  <strong class="price">¥32.9</strong>
                                       </li>
                                       <li>
                                       	  <a><img class="am-thumbnail" src="/Public/Home/images/Hxcag60.jpg" /></a>
                                       	  <strong class="price">¥32.9</strong>
                                       </li>
                                       <li>
                                       	  <a><img class="am-thumbnail" src="/Public/Home/images/youzi.jpg" /></a>
                                       	  <strong class="price">¥32.9</strong>
                                       </li>
                                       <li>
                                       	  <a><img class="am-thumbnail" src="/Public/Home/images/EZA27501.jpg" /></a>
