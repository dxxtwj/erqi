...
<body>
	<div class="login-boxtitle">
		...
		<div style="float:right;line-height:60px;">已激活账号 ? <a href="<?php echo U('Login/login');?>">返回登录</a></div>
	</div>
			...
			<div class="login-box">
				<div class="am-tabs" id="doc-my-tabs">
					<ul class="am-tabs-nav am-nav am-nav-tabs am-nav-justify">
						<li class="am-active"><a href="">重新发送激活邮件</a></li>
					</ul>
				<div class="am-tabs-bd">
					<!-- 重发激活邮件 -->
					<div class="am-tab-panel am-active">
						<form method="post" action="<?php echo U('Login/activationMail');?>" id="emailform">							
			    			...
			    			$.ajax({
			    				...
			    				success: function(data) {
			    					...
			    					if (data == '-1') {
						    			...
						    			// 设置错误信息
			    						var errorMessage = '该邮箱已经激活,请直接登录';
			    						$('<span></span>')
			    						.addClass('error-message')
			    						.text(errorMessage)
			    						.appendTo($listItem);
